...
const returnIfNotEmpty = (value, replaceWith) => (isEmpty(value) ? replaceWith : value)

const hasKey = (object, key) => isObject(object) && !isEmpty(object) && Object.keys(object).includes(key)

const withDefaults = (object, defaults) => ({ ...defaults, ...object })
...
exports.returnIfNotEmpty = returnIfNotEmpty
