...
exports.signInWithProvider = async (req, res) => {
  ...
  return accessToken
    ? res.json({ avatar, firstName, lastName, email, roles, accessToken })
    : httpErrors.wentWrong(res)
}
...
exports.signIn = async (req, res) => {
  ...
  if (!userFound)
    return httpErrors.sendError(res, { errors: { login: ['Invalid Email or Password'] } })
  if (!userFound.verified)
    return httpErrors.sendError(res, { errors: { email: ['Please verify your email'] } })
...
exports.verifyEmail = async (req, res) => {
  ...
  return userUpdated
    ...
    : httpErrors.sendError(res, 'Verification link expired')
}
...
exports.sendVerificationEmail = async (req, res) => {
  ...
  if (userFound.verified)
    return httpErrors.sendError(res, { errors: { email: ['Your email is already verified'] } })
...
exports.signOut = async (req, res) => {
  ...
  if (Object.prototype.hasOwnProperty.call(sessions, uuid))
